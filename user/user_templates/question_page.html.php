                ...
                <div class="col-md-9">
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                        ...
                        <?php if (strcasecmp($_SESSION['username'], $question['username']) === 0): ?>
                            <div class="ml-auto">
                                <a href="question_edit?id=<?= $question['id'] ?>" class="btn btn-outline-primary btn-sm">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <a href="question_delete?id=<?= $question['id'] ?>" class="btn btn-outline-danger btn-sm">
                        ...
                        <div class="answer-footer mt-3 pt-3 border-top">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-4 text-center">
                                    <!-- Edit and Delete Links (if user is the answer's owner) -->
                                    <?php if (strcasecmp($_SESSION['username'], $answer['username']) === 0): ?>
                                        <div class="answer-actions">
                                            <a href="answer_edit?id=<?= $answer['id'] ?>" class="btn btn-outline-primary btn-sm">
                                                <i class="fas fa-edit"></i> Edit
                                            </a>
                                            <a href="answer_delete?id=<?= $answer['id'] ?>" class="btn btn-outline-danger btn-sm">
                                                <i class="fas fa-trash"></i> Delete
                                            </a>
                                        </div>
                                    <?php endif; ?>
    ...
    <div class="answer-form-section">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0"><i class="fas fa-reply"></i> Your Answer</h5>
            </div>
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="text-right">
                        <button type="submit" value="Add" class="btn btn-primary btn-lg">
