        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-right">
                <div class="row text-center">
                    ...
                    <div class="col-6">
                        <a href="new_question" class="btn btn-light btn-sm">
...
<div class="container">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm bg-light">
                <div class="card-body py-3 text-center">
                    ...
                    <a href="new_question" class="btn btn-primary btn-block">
        ...
        <div class="col-12">
            ...
            <?php else: ?>
                ...
                <div class="text-center py-5">
                    ...
                    <a href="new_question" class="btn btn-primary btn-lg">
    ...
    <!-- Call to Action for User Area -->
    <div class="bg-light rounded p-4 mt-5 text-center">
        <h4><i class="fas fa-lightbulb"></i> Got Another Question?</h4>
        <p class="text-muted mb-3">Share your knowledge and help build our community!</p>
        <div>
            <a href="new_question" class="btn btn-primary mr-2">
                <i class="fas fa-plus"></i> Ask a Question
            </a>
            <a href="user_index" class="btn btn-outline-primary">
