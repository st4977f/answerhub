                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6 px-0 d-none d-sm-block">
                            <img src="images\login_image.jpg" alt="Login image" class="w-100 vh-75 pt-5"
                        ...
                        <div class="col-sm-6 text-black">
                            ...
                            <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                                ...
                                <form action="includes\process.php" method="post" style="width: 23rem;">
                                    ...
                                    <div class="pt-1 mb-4">
                                        <button class="btn btn-info btn-lg btn-block" type="submit" submit
                                            name="login">Login</button>
                                    </div>

                                    <p class="small mb-4 pb-lg-2"><a class="text-muted" href="#!">Forgot password?</a>
                                    </p>
                                    <p>Don't have an account? <a href="registration.php" class="link-info">Register
                                            here</a></p>
