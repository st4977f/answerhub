            ...
            <div class="card-body">
                ...
                <div class="card-body ">
                    <p class="card-text text-right float-right pr-2 bg-light rounded" style="width: 12rem; height: 6rem;">
                        <small class="text-muted px-1 float-left">Asked <?=htmlspecialchars($question['questiondate'], ENT_QUOTES, 'UTF-8');?></small>
                        <br>
                        <?php if (!empty($user['profile_image'])): ?>
                            <!-- Display the profile image of the user who asked the question -->
                            <img src="data:image/jpeg;base64,<?=base64_encode($user['profile_image'])?>" alt="Profile Picture" class="card-img-top float-left mx-2" style="width: 55px; height: 55px;">
                        <?php else: ?>
